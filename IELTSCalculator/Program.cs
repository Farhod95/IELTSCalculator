namespace IELTSCalculator
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            Console.Write(" 40 ta savoldan nechtasiga to'g'ri javob berganizni kiriting: ");
            double listeningValue1 = 0;

            if (double.TryParse(Console.ReadLine(), out double listeningValue))
            {
                ListeningBall(listeningValue, ref listeningValue1);  // Metod            
            }
            else { Console.WriteLine("\n Klaviaturadan faqat raqam kiritish lozim !"); return; }
            ...
            {
                ReadingBall(readingValue, ref readingValue1); // Metod  
            }
            else { Console.WriteLine("\n Klaviaturadan faqat raqam kiritish lozim !"); return; }
            ...
            Console.WriteLine(" \n \n WRITING (Yozish) ");
            Console.WriteLine(" \n Quyidagi Task (vazifa)larga qo'yilgan baholarni kiriting");

            Console.Write("   -Task Response -> Vazifaga javob berish: ");
            if (double.TryParse(Console.ReadLine(), out double taskResponseValue))
            {
                if (taskResponseValue > 9 || taskResponseValue < 0) { Console.WriteLine("\n Bunday miqdorda baho olish imkonsiz !"); return; }
            }
            else { Console.WriteLine("\n Klaviaturadan faqat raqam kiritish lozim !"); return; }
            ...
            {
                if (taskCoherenceValue > 9 || taskCoherenceValue < 0) { Console.WriteLine("\n Bunday miqdorda baho olish imkonsiz !"); return; }
            }
            else { Console.WriteLine("\n Klaviaturadan faqat raqam kiritish lozim !"); return; }
            ...
            {
                if (taskLexicalValue > 9 || taskLexicalValue < 0) { Console.WriteLine("\n Bunday miqdorda baho olish imkonsiz !"); return; }
            }
            else { Console.WriteLine("\n Klaviaturadan faqat raqam kiritish lozim !"); return; }

            Console.Write("   -Grammar -> Grammatika: ");
            if (double.TryParse(Console.ReadLine(), out double taskGrammarValue))
            {
                if (taskGrammarValue > 9 || taskGrammarValue < 0) { Console.WriteLine("\n Bunday miqdorda baho olish imkonsiz !"); return; }
            }
            else { Console.WriteLine("\n Klaviaturadan faqat raqam kiritish lozim !"); return; }
            double writingValue11 = 0;

            WritingBall(taskResponseValue, taskCoherenceValue, taskLexicalValue, taskGrammarValue, ref writingValue11); // Metod  
            ...
            {
                if (taskFluencyValue > 9 || taskFluencyValue < 0) { Console.WriteLine("\n Bunday miqdorda baho olish imkonsiz !"); return; }
            }
            else { Console.WriteLine("\n Klaviaturadan faqat raqam kiritish lozim !"); return; }
            ...
            {
                if (taskResourceValue > 9 || taskResourceValue < 0) { Console.WriteLine("\n Bunday miqdorda baho olish imkonsiz !"); return; }
            }
            else { Console.WriteLine("\n Klaviaturadan faqat raqam kiritish lozim !"); return; }
            ...
            {
                if (taskAccuracyValue > 9 || taskAccuracyValue < 0) { Console.WriteLine("\n Bunday miqdorda baho olish imkonsiz !"); return; }
            }
            else { Console.WriteLine("\n Klaviaturadan faqat raqam kiritish lozim !"); return; }
            ...
            {
                if (taskPronunciationValue > 9 || taskPronunciationValue < 0) { Console.WriteLine("\n Bunday miqdorda baho olish imkonsiz !"); return; }
            }
            else { Console.WriteLine("\n Klaviaturadan faqat raqam kiritish lozim !"); return; }
            ...
            IELTSBall(listeningValue1, readingValue1, writingValue11, speakingValue11, ref ieltsValue1);   // Metod     
        ...
        static void ListeningBall(double listeningValue, ref double listeningValue1)
        {
            switch (listeningValue)
            {
                ...
                default: Console.WriteLine("\n Bunday miqdorda to'g'ri javob berish imkonsiz !"); break;
            }
        }
